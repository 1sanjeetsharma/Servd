        ...
        <div className=" max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            <div className="flex-1 text-center md:text-left">
              <Badge
                variant="outline"
                className="flex items-center gap-1.5 px-3 py-1 border-2 border-orange-600 text-orange-700 bg-orange-50 text-sm font-bold mb-6 uppercase tracking-wide"
              >
                <Flame className="h-4 w-4" />
                <span>#1 AI Cooking Assistant</span>
              </Badge>
            ...
            <Card
              className={
                "relative aspect-square ms:aspect-4/5 border-4 border-stone-900 bg-stone-200 overflow-hidden py-0"
              }
            >
              <Image
                src={"/pasta-dish.png"}
