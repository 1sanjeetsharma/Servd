    ...
    <div className="min-h-screen bg-stone-50 py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-5">
          ...
          <p className="text-xl text-orange-600 font-light max-w-2xl">
              ...
              <div className="relative bg-white border-2 border-stone-900 overflow-hidden hover:border-orange-600 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <p className="text-stone-600 mb-6 line-clamp-3 font-light text-light text-lg">
        ...
        <section className="mb-24">
          <div className="mb-8">
            <h2 className="text-lg md:text-5xl font-bold text-stone-900 mb-2">
              Browse by Category
            </h2>
